...
using LytvynenkoWebApplication;

namespace LytvynenkoWebApplication.Controllers
{
    public class FactoriesController : Controller
    {
        ...
        {
            var dBLytvynenkoContext = _context.Factories.Include(f => f.IdNavigation);
        ...
        {
            ViewData["Id"] = new SelectList(_context.Cities, "Id", "Id");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,CityId,Name")] Factory factory)
        {
            ...
            ViewData["Id"] = new SelectList(_context.Cities, "Id", "Id", factory.Id);
            return View(factory);
        }
