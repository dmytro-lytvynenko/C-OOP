...
namespace BikesWebApplication.Controllers
{
    public class ColorsController : Controller
    {
        ...
        public ColorsController(DBLytvynenkoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Colors != null ? 
                          ...
                          Problem("Entity set 'DBLytvynenkoContext.Colors'  is null.");
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            return RedirectToAction("Index", "BikesInColors", new { id = color.Id, name = color.Name });
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DBLytvynenkoContext.Colors'  is null.");
            }
            var color = await _context.Colors.FindAsync(id);
            if (color != null)
            {
