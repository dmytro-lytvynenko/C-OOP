...
namespace LabCalculator
{
    public class Table
    {
        ...
        {
            grid[row][col].DeletePointersAndReference();
            ...
            {
                System.Windows.Forms.MessageBox.Show("There is a loop! Change the expresion.");
        ...
        {
            string cellPatern = @"[A-Z]+[0-9]+";
            Regex regex = new Regex(cellPatern, RegexOptions.IgnoreCase);
            Index nums;
        ...
        public void AddRow(System.Windows.Forms.DataGridView dataGridView1)
        {
            ...
            for(int j = 0; j < colCount; j++)
            {
                newRow.Add(new LabCalculator.Cell(rowCount, j));
                dictionary.Add(newRow.Last().getName(), "");
            }
            grid.Add(newRow);
            RefreshReferences();
        ...
        public void AddColumn(System.Windows.Forms.DataGridView dataGridView1)
        {
            ...
            {
                newCol.Add(new LabCalculator.Cell(colCount, j));
                dictionary.Add(newCol.Last().getName(), "");
            }
            grid.Add(newCol);
            RefreshReferences();
            foreach (List<Cell> list in grid)
        ...
        public bool DeleteRow(System.Windows.Forms.DataGridView dataGridView1)
        {
            ...
            if(lastRow.Count != 0 || notEmptyCells.Count != 0)
            {
                ...
                errorMessage += "Are you sure you want delete this row?";
                System.Windows.Forms.DialogResult res = System.Windows.Forms.MessageBox.Show(errorMessage, "Warning", 
